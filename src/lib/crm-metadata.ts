...
export const FORM_DEFINITIONS: Partial<Record<CrmObject, FormDefinition>> = {
  Account: {
    ...
    fields: [
      ...
      { name: "ownerId", label: "Account Owner", section: "About", type: "lookup", lookupObject: "User", defaultValue: CURRENT_USER.id },
  ...
  Contact: {
    ...
    fields: [
      ...
      { name: "description", label: "Description", section: "About", type: "textarea" },
      { name: "ownerId", label: "Contact Owner", section: "About", type: "lookup", lookupObject: "User", defaultValue: CURRENT_USER.id },
      { name: "phone", label: "Phone", section: "Get in Touch", type: "phone" },
  ...
  Lead: {
    ...
    fields: [
      ...
      { name: "website", label: "Website", section: "About", type: "url" },
      { name: "description", label: "Description", section: "About", type: "textarea" },
      { name: "ownerId", label: "Lead Owner", section: "About", type: "lookup", lookupObject: "User", defaultValue: CURRENT_USER.id },
  ...
  Opportunity: {
    ...
    fields: [
      ...
      { name: "description", label: "Description", section: "About", type: "textarea" },
      { name: "ownerId", label: "Opportunity Owner", section: "About", type: "lookup", lookupObject: "User", defaultValue: CURRENT_USER.id },
  ...
  Case: {
    ...
    fields: [
      ...
      { name: "ownerId", label: "Case Owner", section: "Case Information", type: "lookup", lookupObject: "User", defaultValue: CURRENT_USER.id },
