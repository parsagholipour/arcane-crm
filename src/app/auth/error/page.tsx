  ...
  return (
    <main className="grid min-h-screen place-items-center bg-slate-50 p-6">
      <section className="w-full max-w-md rounded-lg border bg-white p-8 text-center shadow-sm">
        ...
        <Link className="mt-6 inline-flex rounded bg-brand-600 px-4 py-2 text-sm font-semibold text-white hover:bg-brand-700" href="/auth/keycloak?callbackUrl=/">Try again</Link>
      </section>
    </main>
  );
}
