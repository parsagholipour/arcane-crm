  ...
  try {
    ...
    return (
      <div className="min-h-screen bg-[#f3f3f3] text-[#181818]">
        <header className="flex min-h-14 items-center border-b bg-white px-5"><Link href="/lightning/page/home"><ReloriqLogo wordmarkClassName="text-lg font-bold text-shell" /></Link><span className="ml-auto text-sm text-[#706e6b]">{user.email}</span></header>
